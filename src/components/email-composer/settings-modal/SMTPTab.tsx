...
import { SMTPConfig, SMTPConfigForm } from '@/types/smtp';
      ...
      {!hasConfigs && !showForm && (
        <Alert severity="warning" sx={{ mb: 3 }}>
          ...
          <Typography variant="body2">
            You need to configure at least one SMTP server to send emails. Click
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Box sx={{ px: 2, py: 1 }}>
          ...
          <Typography variant="caption" color="text.secondary">
            The default configuration will be used when clicking the Send button
            directly.
          </Typography>
        </Box>
        ...
        {hasConfigs && (
          <Alert severity="info" sx={{ mt: 2 }}>
            <Typography variant="body2">
              All SMTP configurations are stored securely in your browser&apos;s
              local storage. You can add multiple configurations and set any one
              as the default for quick sending.
            </Typography>
          </Alert>
        )}
      </Box>
